...
for (const [label, source, tokens] of [
  ...
  [
    ...
    [
      ...
      'canvas_normalize',
      'plan self hash mismatch',
      'plan effect boundary changed',
      'provider operations cannot enter deterministic Pillow processing',
      'output path extension differs from runtimeFormat',
...
runNodeCheck('Raster effect CLI syntax validation', [
  '--check',
  'tools/create_raster_effect_layer.mjs',
]);
