...
process.stdout.write(`${JSON.stringify({
  ...
  includesDurableResumeStateModule: true,
  includesRecoveredArtifactRevalidation: true,
  includesExplicitQaFailurePolicy: true,
  includesDurableResumeExecution: false,
