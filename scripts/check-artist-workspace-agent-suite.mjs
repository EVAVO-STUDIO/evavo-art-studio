...
console.log('- v5 adds deterministic pixel finishing and named-human final-frame admission');
console.log('- one existing consolidated workflow validates all five contracts');
