...
export const LAYERED_GODOT_GIT_DELIVERY_EVIDENCE_PROTOCOL_VERSION = "2026-08-13.1";
export const LAYERED_GODOT_GIT_DELIVERY_EVIDENCE_KIND =
  "evavo.layered-production.godot-git-delivery-evidence-bundle";
export const LAYERED_GODOT_GIT_DELIVERY_EVIDENCE_PUBLICATION_PROTOCOL_VERSION =
  "2026-08-13.1";
export const LAYERED_GODOT_GIT_DELIVERY_EVIDENCE_PUBLICATION_KIND =
