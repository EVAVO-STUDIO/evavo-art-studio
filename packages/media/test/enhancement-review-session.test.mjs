...
function manifest(source, candidate, width, height, role = "illustration", profile = "illustration", learned = false) {
  ...
  return {
    ...
    mandatory_visual_checks: [
      "create durable source-bound image review session",
      "review ranked defect and artifact evidence",
      ...
      ...(workHeader ? [
        ...
        "admit exact browser preview evidence",
    ...
    candidate_preview_admission_required: workHeader,
