...
const ROUTES: Readonly<Record<ImageAgentGoal, Omit<ImageAgentRoute, "contract" | "goal">>> = Object.freeze({
  ...
  "texture-review": Object.freeze({
    primarySurface: "evavo-texture-review",
    orderedTools: Object.freeze(["evavo_review_texture_map", "evavo_create_texture_tile_proof"]),
    writeClass: "read-only",
    prerequisites: Object.freeze(["declared map kind", "declare seamless expectation when applicable"]),
    stopConditions: Object.freeze(["scalar colour contamination", "normal-vector failure", "seam failure", "shader/channel convention unknown"]),
    evidenceExpected: Object.freeze(["per-channel statistics", "seam error", "map-specific warnings", "optional 3x3 proof"]),
    notes: Object.freeze(["Never silently flip normal channels or repack PBR maps without the target shader contract."]),
  }),
