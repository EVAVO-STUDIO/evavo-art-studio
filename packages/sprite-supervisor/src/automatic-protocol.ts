...
export function automaticSpriteWorkflowProtocolSummary() {
  return {
    ...
    mirrorRules: [
      ...
      "Asymmetry, held items, equipment or costume swaps, unsupported normal maps, unsafe cameras, directional lighting, historical handedness or off-axis pivots block derivation.",
