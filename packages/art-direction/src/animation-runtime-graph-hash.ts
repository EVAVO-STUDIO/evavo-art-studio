import type { AnimationRuntimeDigest } from "./animation-runtime-graph-types.js";
...
export function animationRuntimeGraphSha256(value: unknown): AnimationRuntimeDigest {
  return `sha256:${sha256Hex(JSON.stringify(canonicalise(value)))}`;
}

export function animationRuntimeGraphDigest(value: unknown): AnimationRuntimeDigest {
  return animationRuntimeGraphSha256(value);
}
