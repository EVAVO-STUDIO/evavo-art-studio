...
export function artProductionOrchestratorProtocolSummary() {
  return freeze({
    ...
    loop: [
      ...
      "bind provider request, provider response, retained PNG and inspection evidence to the exact current job",
      "admit the candidate through a deterministic receipt before technical review",
      ...
      "bind runtime assembly sources to exact packaging, admission, technical-review and approval-receipt lineage",
    ] as const,
    boundaries: freeze({
