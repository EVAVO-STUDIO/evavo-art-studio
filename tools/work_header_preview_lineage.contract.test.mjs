...
test("preview admission requires immutable candidate artifact and exact Chrome response-body identity", async () => {
...
test("preview admission verifier rejects stale browser/artifact/remote evidence", async () => {
  const source = await read("./work_header_preview_admission_mcp.mjs");
  for (const token of [
