#!/usr/bin/env python3
"""Build a deterministic, create-only project-art sprite atlas."""
...
from project_art_atlas_contract import MAXIMUM_PLAN_BYTES, fail
...
def main() -> int:
    ...
    try:
        ...
        receipt = execute(plan, plan_bytes, Path(os.path.abspath(args.output_root)))
    except (OSError, ValueError, json.JSONDecodeError) as exc:
        print(f"Project-art atlas failed: {exc}", file=sys.stderr)
        return 2
    print(
        json.dumps(
            {
