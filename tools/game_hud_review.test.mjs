...
const base={schemaVersion:SCHEMA,projectId:"hypersonic",logicalViewport:{width:640,height:360},elements:[
  {id:"flight",rect:{x:8,y:270,width:128,height:28},persistence:"permanent",priority:"tactical",opacity:0.3,cluster:"lower-left"},
  {id:"systems-radar",rect:{x:532,y:270,width:100,height:80},persistence:"permanent",priority:"critical",opacity:0.34,cluster:"lower-right"},
