...
async function runPageReview(args) {
  ...
  return { ok: true, proofPath, receiptPath, immutablePreviewCandidateArtifactVerified: true, browserResponseMetadataBound: true, fullReceiptLineageBound: true, exactPreviewedCandidateBytesMatchedSelectedCandidate: true, evidence: result.evidence };
}
...
async function verifyPageReceipt(p) {
  ...
  return { path: receipt.path, sha256: receipt.sha256, byteLength: receipt.byteLength, value, selection, preview, fullReceiptLineageVerified: true };
}
