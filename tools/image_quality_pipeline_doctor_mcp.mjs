...
async function inspect() {
  ...
  return Object.freeze({
    contract: "evavo.image-quality-pipeline-doctor.v1_31",
    ...
    nextAction: blockers.length
      ...
      : "Static image-quality evidence now runs from preservation through exact browser review, deterministic page-review recomputation, explicit approval, rollback-safe publication planning, execution/postflight evidence, rollback closure and a durable transaction-state ledger distinguishing published/rollback-ready from rolled-back/closed state.",
  });
}
...
const tools = Object.freeze([
  ...
  { name: "evavo_run_image_quality_pipeline_doctor", description: "Inspect preservation, deterministic reviewed-image evidence, target-aware publication protection, post-publication verification, rollback evidence and durable transaction state without mutating source, website or Cloudinary state.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
]);
